...
return [
    ...
    'timestamp' => 1753704385,
    'checksum' => '84638aa0d42400c1f7ed27c91ecd01d7',
    'files' => [
        ...
        'user/themes' => [
            'themes/bullet' => [
                'file' => 'user/themes/bullet/blueprints.yaml',
                'modified' => 1746499527
            ],
            'themes/classic' => [
                'file' => 'user/themes/classic/blueprints.yaml',
                'modified' => 1746443250
            ],
            'themes/mytheme' => [
            ...
            'themes/theme4' => [
                'file' => 'user/themes/theme4/blueprints.yaml',
                'modified' => 1753515972
            ],
            'themes/theme99' => [
                'file' => 'user/themes/theme99/blueprints.yaml',
                'modified' => 1746499527
            ]
        ]
    ],
    'data' => [
        'items' => [
            ...
            'themes.mytheme.header.hero_classes' => [
                'type' => 'text',
                'label' => 'Hero Classes',
                'details' => NULL,
                'name' => 'themes.mytheme.header.hero_classes'
            ],
            'themes.mytheme.header.hero_image' => [
                'type' => 'pagemediaselect',
                'label' => 'Hero Image',
                'preview_images' => true,
                'name' => 'themes.mytheme.header.hero_image'
            ],
            'themes.mytheme.buttons' => [
                'type' => 'section',
                'name' => 'themes.mytheme.buttons'
            ],
            'themes.mytheme.tabs' => [
        ...
        'nested' => [
            ...
            'themes' => [
                'bullet' => 'themes.bullet',
                'classic' => 'themes.classic',
                'mytheme' => [
                    'tabs' => 'themes.mytheme.tabs',
                    'buttons' => 'themes.mytheme.buttons',
                    'header' => [
                        'hero_classes' => 'themes.mytheme.header.hero_classes',
                        'hero_image' => 'themes.mytheme.header.hero_image'
                    ]
                ],
                'quark' => [
